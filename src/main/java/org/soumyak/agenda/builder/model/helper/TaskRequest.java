...
public class TaskRequest {
    ...
    @Json(name = "section_id") public Integer sectionId;
    ...
    public TaskRequest(String content, Long projectId, Integer sectionId, Integer order, List<Long> labelIds, Integer priority, String dueString, String dueDate, String dueDateTime, String dueLang) {
